...
namespace FlitBit.ObjectIdentity
{
  ...
  {
    internal static MethodInfo TypeEmitter = typeof(IdentityKeyEmitter).MatchGenericMethod(
      "EmitType",
      BindingFlags.NonPublic | BindingFlags.Static, 1,
      typeof(Type)
      );
    ...
    static Type BuildType<T>(EmittedModule module, string typeName)
    {
      ...
      var cls = module.DefineClass(typeName, EmittedClass.DefaultTypeAttributes, supertype, null);
